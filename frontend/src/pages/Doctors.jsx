    ...
    return (
        <div>
            ...
            <div className="flex flex-col sm:flex-row  items-start gap-5 mt-5">
                <button className={`py-1px-3 border rounded text-sm transition-all sm:hidden ${showFilter ? 'bg-[#5F6FFF] text-white' : ''}`} onClick={() => setShowFilter(prev => !prev)}>Filters</button>
